...
list_cutDFs<-list(#list_cutFc,
                  list_cutHc,
                  list_cutKin, 
                  list_cutRGB_C_hexcodes, 
                  list_cutRgb_M)
...
list_meltHC<-list_melt_dfs[[1]]#list_meltHC<-list_melt_dfs[[2]]
list_melt_Kin<-list_melt_dfs[[2]]#list_melt_Kin<-list_melt_dfs[[3]]
list_meltRGBC<-list_melt_dfs[[3]]#list_meltRGBC<-list_melt_dfs[[4]]
list_meltRGBM<-list_melt_dfs[[4]]#list_meltRGBM<-list_melt_dfs[[5]]
