...
requiredPackages<-c("readxl",
                    ...
                    "reshape2",
                    "stringr",
                    "sjmisc","ggpubr","matrixStats", "gridExtra","corrplot","nlme","lme4","car","emmeans","multcomp","multcompView", "lmtest","GGally","RColorBrewer","MultivariateRandomForest", "multivar","randomForestSRC", "rsample","ggsci","corrr","ggcorrplot","FactoMineR","vcd","factoextra","rfPermute","ggfortify","agricolae","randomForest","stats","ade4","magrittr","cluster","ggstatsplot","rstatix")
