...
#Hier muss ich noch schauen, wie ich das am betsen löse, die Gruppen mit nur einer observation machen hier Probleme beim plotten....

 ggboxplot(list_anovas_NDVI_allPosthocs[[8]], x=".group", y="emmean", color="Condition", facet.by = ".group")
